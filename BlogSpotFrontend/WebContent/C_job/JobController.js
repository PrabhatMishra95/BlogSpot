...
myApp.controller("JobController", function($scope,$route, $http, $location,$rootScope, $window) {
	...
	$scope.insertJob = function() {
		...
		$http.post("http://localhost:8078/BlogSpotMiddleware/addJob",
	...
	function fetchAllJobs() {
		...
		$http.get("http://localhost:8078/BlogSpotMiddleware/listJobs").then(
				function(response) {
					console.log('Status text:' + response.statusText);
	...
	$rootScope.viewJob = function(jobId) {
		...
		$http.get('http://localhost:8078/BlogSpotMiddleware/getJob/' + jobId)
	 ...
	 * $http.get('http://localhost:8078/BlogSpotMiddleware/getJob/'+job.jobId)
	...
	$scope.applyJobs=function()
	{
		...
		$http.post('http://localhost:8078/BlogSpotMiddleware/applyJob',$scope.applyJob).then(function(response)
				{
	...
	function listApplyJob()
	{
		...
		$http.get('http://localhost:8078/BlogSpotMiddleware/listAppliedJobs')
		.then(function(response)
				{
	...
	$scope.updateJob = function(jobId){
		...
		console.log(jobId);
		$http.put('http://localhost:8078/BlogSpotMiddleware/updateJob/'+ jobId, $scope.job)
	...
	$scope.approveJob = function(jobId){
		...
		console.log(jobId);
		$http.put('http://localhost:8078/BlogSpotMiddleware/approveJob/'+ jobId)
		.then(fetchAllJobs(), function(response){
	...
	$scope.rejectJob = function(jobId){
		...
		console.log(jobId);
		$http.put('http://localhost:8078/BlogSpotMiddleware/rejectJob/'+ jobId)
		.then(fetchAllJobs(), function(response){
	...
	$scope.deleteJob = function(jobId){
		...
		$http.delete('http://localhost:8078/BlogSpotMiddleware/deleteJob/'+jobId)
		.then(fetchAllJobs(), function(response){
	...
	$scope.fetchAllJobComments=function(jobId) {
		...
		$http.get("http://localhost:8078/BlogSpotMiddleware/"+jobId).then(
				function(response) {
					console.log('Status text:' + response.statusText);
	...
	$scope.addJobComment = function(jobId) {
		...
		$http.post("http://localhost:8078/BlogSpotMiddleware/addJobComment",
